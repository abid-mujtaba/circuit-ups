   ...
   \begin{center}
      ...
      \begin{figure}[h!]
         ...
         \begin{circuitikz}
            ...
            \draw (t2.collector) -| (9.25, 2.5);                  % The -| notation allows us to construct right-angled shorted wires between the specified nodes. |- draws the corner in the opposite direction
